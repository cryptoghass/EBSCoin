![Example-Logo](https://i.imgur.com/sQbAvtL.png)
# Elbrus Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Elbrus Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/CFe8ga4)
***
## Requirements
1) **10,000 EBS coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/EBSCoin/master/elburs_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash elbrus_install.sh`
...
***Step 1***
* Download and install the Elbrus wallet [here](https://www.elbruscoin.com/downloads)
***

***Step 2***
* Send EXACLY 10,000 EBS to a receive address within your wallet.
***
